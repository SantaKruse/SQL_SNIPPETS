...
Once the function has been created it can be called by running the following command where **yourfield1** is the database field of the patient ID and **yourfield2**  is the database field of the eGFR value to be adjusted: 
